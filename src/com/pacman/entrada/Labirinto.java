...
public class Labirinto {
	...
	public static String labirinto = ""
			...
			+ " x..........................................x "
			+ " x.xxxxxx.xxx.xxxexxxxxxxexxx.xxxx.xxxxxxxxxx "
			+ " x.x    x.x x.x xex     xex x.x  x.x          "
			+ " x.xxxxxx.x x.x xexxxxxxxex x.x  x.x          "
			+ " x........xxx.x xeeeeeeeeex x.x  x.x          "
			+ " x.xxxxxx.....xxxeeeeeeeeexxx.xxxx.x          "
